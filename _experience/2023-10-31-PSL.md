...
**Products:**
- <img src="{{ base_path }}/assets/icons/surecash-icon.svg" alt="SureCash" height="20"> SureCash
- <img src="{{ base_path }}/assets/icons/tallypay-icon.svg" alt="TallyPay" height="20"> TallyPay
- <img src="{{ base_path }}/assets/icons/tallykhata-icon.svg" alt="TallyKhata" height="20"> TallyKhata
