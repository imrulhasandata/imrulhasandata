...
<strong class="header_section">Products:</strong> <br />
- <img src="{{ base_path }}/assets/icons/surecash-icon.svg" alt="SureCash" height="20">
- <img src="{{ base_path }}/assets/icons/tallypay-icon.svg" alt="TallyPay" height="20">
- <img src="{{ base_path }}/assets/icons/tallykhata-icon.svg" alt="TallyKhata" height="20">
