...
<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-sql-server.svg" alt="SQL Server" height="20"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/postgresql-96.svg" alt="PostgreSQL" height="20"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-mysql.svg" alt="MySQL" height="20"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-mongodb.svg" alt="MongoDB" height="20"><br/>
</div>

<!--  -->

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-google-data-studio.svg" alt="Looker Studio" height="20"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-power-bi.svg" alt="Power BI" height="20"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/Apache Superset.svg" alt="Apache Superset" height="20"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-python.svg" alt="Python" height="20"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/django.svg" alt="Django" height="20"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/linux.svg" alt="Linux" height="20"><br/>
</div>
