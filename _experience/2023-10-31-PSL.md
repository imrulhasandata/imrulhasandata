...
<body>
  ...
  <div style="text-align: center; margin: 10px;">
    <img src="https://www.cdnlogo.com/logos/p/93/postgresql.svg" alt="PostgreSQL" height="30"><br/>
    PostgreSQL
  </div>

  <div style="text-align: center; margin: 10px;">
    <img src="https://cdn.example.com/mysql-logo.png" alt="MySQL" height="30"><br/>
    MySQL
  </div>

  <div style="text-align: center; margin: 10px;">
    <img src="https://cdn.example.com/sql-server-logo.png" alt="SQL Server" height="30"><br/>
    SQL Server
  </div>

  <div style="text-align: center; margin: 10px;">
    <img src="https://cdn.example.com/looker-logo.png" alt="Looker Studio" height="30"><br/>
    Looker Studio
  </div>
