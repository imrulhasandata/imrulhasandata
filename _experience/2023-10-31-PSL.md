...
<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-sql-server.svg" alt="SQL Server" style="width: 20%;"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/postgresql-96.svg" alt="PostgreSQL" style="width: 20%;"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-mysql.svg" alt="MySQL" style="width: 20%;"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-mongodb.svg" alt="MongoDB" style="width: 20%;"><br/>
</div>

<!--  -->

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-google-data-studio.svg" alt="Looker Studio" style="width: 20%;"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-power-bi.svg" alt="Power BI" style="width: 20%;"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/Apache Superset.svg" alt="Apache Superset" style="width: 20%;"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/icons8-python.svg" alt="Python" style="width: 20%;"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/django.svg" alt="Django" style="width: 20%;"><br/>
</div>

<div style="text-align: center; margin: 10px;">
  <img src="{{ base_path }}/assets/icons/linux.svg" alt="Linux" style="width: 20%;"><br/>
</div>
